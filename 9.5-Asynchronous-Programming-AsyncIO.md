...
- [1. Synchronous vs. Asynchronous: The Core Mental Model](#1-synchronous-vs-asynchronous-the-core-mental-model)
- [2. Meet `asyncio`: The Engine Under the Hood](#2-meet-asyncio-the-engine-under-the-hood)
- [3. The Core Building Blocks: `async def`, `await`, Coroutines, and Tasks](#3-the-core-building-blocks-async-def-await-coroutines-and-tasks)
- [4. Running Tasks Concurrently: `asyncio.gather()` and Modern `TaskGroup`](#4-running-tasks-concurrently-asynciogather-and-modern-taskgroup)
- [5. Visualizing Execution: Deep Dive with Diagrams](#5-visualizing-execution-deep-dive-with-diagrams)
- [6. Python `asyncio` vs. JavaScript & Node.js: The Complete Breakdown](#6-python-asyncio-vs-javascript-nodejs-the-complete-breakdown)
- [7. Crucial Gotchas & Beginner Pitfalls](#7-crucial-gotchas-beginner-pitfalls)
- [8. Real-World Async Patterns & Use Cases](#8-real-world-async-patterns-use-cases)
