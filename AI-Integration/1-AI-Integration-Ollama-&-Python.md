...
| **LangChain (LCEL)**             | A composition framework for chaining prompts, vector retrievers, and LLMs using the pipe operator (`\|`). | Standardizes RAG pipelines and eliminates glue-code between databases and model runtimes.                      |
